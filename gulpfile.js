...
elixir(function(mix) {
    ...
    //copy files
    mix.copy('vendor/almasaeed2010/adminlte/bower_components/bootstrap/dist/css/bootstrap.css',
        'public/css/libs/bootstrap.css');
    mix.copy('vendor/almasaeed2010/adminlte/dist/css/AdminLTE.css',
    ...
    mix.copy('vendor/almasaeed2010/adminlte/dist/js/adminlte.js',
        'public/js/libs/admin-lte.js');
    mix.copy('vendor/almasaeed2010/adminlte/bower_components/bootstrap/dist/js/bootstrap.js',
        'public/js/libs/bootstrap.js');

    mix.copy('vendor/almasaeed2010/adminlte/bower_components/jquery/dist/jquery.js',
        'public/js/libs/jquery.js');

    mix.copy('node_modules/axios/dist/axios.js',
